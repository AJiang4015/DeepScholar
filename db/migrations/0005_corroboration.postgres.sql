-- 0005_corroboration（F5，postgres 方言）
...
CREATE TABLE IF NOT EXISTS corroborations (
    ...
    method_spec            JSONB NOT NULL,
    method_fingerprint     TEXT NOT NULL,
    status                 TEXT NOT NULL,
    error                  TEXT,
    computed_at            TIMESTAMPTZ NOT NULL,
    metadata               JSONB NOT NULL DEFAULT '{}',
    global_clusters        JSONB NOT NULL DEFAULT '[]',
    support                JSONB NOT NULL DEFAULT '{}',
    contradict             JSONB NOT NULL DEFAULT '{}',
    conflicts_independence JSONB NOT NULL DEFAULT '[]',
    source_profile         JSONB NOT NULL DEFAULT '{}',
